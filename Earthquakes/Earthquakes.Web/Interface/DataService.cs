...
namespace Earthquakes.Web.Interface
{
    ...
    public class DataService : Service
    {
        ...
        public object Get(RingsGet request)
        {
            ...
            return RequestContext.ToOptimizedResultUsingCache(Cache, cacheKey, TimeSpan.FromMinutes(1), () =>
            {
                var gateway = new ProjectGateway();
                var result = gateway.Project<Point>(new List<Feature<Point>> { new Feature<Point> { Geometry = new Point { X = request.X, Y = request.Y } } }, new SpatialReference { Wkid = 2193 });
                ...
                var result2 = gateway.Project<Polygon>(rings, SpatialReference.WGS84);
